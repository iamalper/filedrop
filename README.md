...
<img style="height: 20%; width: 20%" alt='Screenshot 0' src='screenshots_en/Google Pixel 4 XL Screenshot 0.png'/>
<img style="height: 20%; width: 20%" alt='Screenshot 1' src='screenshots_en/Google Pixel 4 XL Screenshot 1.png'/>
<img style="height: 20%; width: 20%" alt='Screenshot 2' src='screenshots_en/Google Pixel 4 XL Screenshot 2.png'/>
